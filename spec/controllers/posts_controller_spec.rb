...
RSpec.describe PostsController, type: :controller do
  ...
  context "moderator user" do
    before do
      user = User.create!(name: "Moderator User", email: "moderator@example.com", password: "helloworld", role: :moderator)
      create_session(user)
    end
    ...
    describe "POST create" do
      it "creates a new post with expected attributes" do
        new_title = RandomData.random_sentence
        new_body = RandomData.random_paragraph

        put :create, id: my_post.id, post: {title: new_title, body: new_body}

        new_post = assigns(:post)
        expect(new_post.id).to eq my_post.id
